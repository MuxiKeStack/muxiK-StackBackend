...
// 2020-01-19 16:04:56.379792414 +0800 CST m=+0.383285796
    ...
    "definitions": {
        ...
        "grade.GetGradeResponse": {
            ...
            "properties": {
                ...
                "section_1": {
                    "description": "成绩区间1,85以上",
                    "type": "number"
                },
                "section_2": {
                    "description": "区间2，70-85",
                    "type": "number"
                },
                "section_3": {
                    "description": "区间3，85以下",
                    "type": "number"
                },
                "total_score": {
                    "description": "总成绩均分",
        ...
        "model.ClassInfoInCollections": {
            ...
            "properties": {
                ...
                "teacher": {
                    "description": "TeachingClassId uint64                        ` + "`" + `json:\"teaching_class_id\"` + "`" + ` // 教学班编号",
                    "type": "string"
                },
                "times": {
                    "type": "array",
        ...
        "search.searchHistoryCourseResponse": {
            ...
            "properties": {
                "courses": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/service.CourseInfoForHistory"
                    }
                },
                "length": {
                    "type": "integer"
        ...
        "search.searchResponse": {
            ...
            "properties": {
                "courses": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/service.CourseInfoForUsing"
                    }
                },
                "length": {
                    "type": "integer"
        ...
        "service.ProducedCourseItem": {
            ...
            "properties": {
                ...
                "has_evaluated": {
                    "description": "Academic     string ` + "`" + `json:\"academic\"` + "`" + `",
                    "type": "boolean"
                },
                "name": {
                    "type": "string"
